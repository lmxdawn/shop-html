				...
				<view class="page-view">
					<swiper indicator-dots autoplay circular :interval="5000" :duration="150" class="swiper">
						<swiper-item v-if="index%2===0" @tap.stop="detail">
							<image src="/static/images/banner/2.jpg" class="slide-image" />
						</swiper-item>
						<swiper-item @tap.stop="detail">
							<image src="/static/images/banner/4.jpg" class="slide-image" />
						</swiper-item>
						<swiper-item @tap.stop="detail">
							<image src="/static/images/banner/5.jpg" class="slide-image" />
						</swiper-item>
					</swiper>
						...
						<view class="class-item">
							...
							<view class="g-container">
								...
								<view class="g-box" @tap.stop="productList" data-key="抽纸">
									<image src="/static/images/product2/55.jpg" class="g-image" />
